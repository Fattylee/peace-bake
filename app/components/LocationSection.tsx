      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
        <div>
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3 mt-2">
              <WhatsAppIcon className="text-green-600 dark:text-green-400 w-6 h-6 shrink-0" />
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 dark:bg-slate-800 dark:text-gray-200 transition-colors">
          ...
          <a
            ...
            className="mt-8 inline-block bg-amber-700 text-white px-6 py-3 rounded-xl hover:bg-amber-800 dark:bg-amber-600 dark:hover:bg-amber-700 transition"
          >
            Call Now
          </a>
        </div>
