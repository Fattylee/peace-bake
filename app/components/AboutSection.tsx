const ABOUT_CARDS = [
  {
    title: "Always Fresh",
    body: "We bake daily to ensure every customer enjoys fresh, nourishing bread straight from the oven.",
  },
  {
    title: "Quality Ingredients",
    body: "We source the finest local flours and natural ingredients — no shortcuts. Expect bold, honest flavors and textures you can taste in every bite.",
  },
  {
    title: "Loved by the Community",
    body: "Loved by neighbors and visitors alike — our warm loaves and friendly service keep customers coming back season after season.",
  },
];
      ...
      <div className="mt-12 max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
        {ABOUT_CARDS.map((card, index) => (
          ...
          >
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300">{card.body}</p>
          </div>
        ))}
      </div>
    </section>
